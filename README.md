>[!CAUTION]
>This site is running but no longer maintained. 
>Information published is unverified and may not hold true.
...
### `npm run package`
Installs missing modules and Runs the app in the development mode.<br />
...
Run `npm install` to install required packages without starting app. `npm start` to Start the Application thereafter.
